    ...
    if (error.name === 'AxiosError') {
      switch (error.response.status) {
        ...
        case 429:
          ...
          break;
        case 500:
          Toast.error('Error: Server internal error, please contact the online customer service!');
          break;
        case 405:
...
/**
 * 比较两个对象的属性，找出有变化的属性，并返回包含变化属性信息的数Group
 * @param {Object} oldObject - 旧对象
 * @param {Object} newObject - 新对象
 * @return {Array} 包含变化属性信息的数Group，每个元素是一个对象，包含 key, oldValue 和 newValue
 */
